...
namespace DVLD
{
  ...
  private int _LicenseID;
        ...
        {
            ShowUserDetails showUser = new ShowUserDetails(clsGloabalcs.CurrentUser.UserID);
           showUser.ShowDialog();
        }
        ...
        {
            ChangePassword changePassword = new ChangePassword(clsGloabalcs.CurrentUser.UserID);
            changePassword.ShowDialog();
        }

        private void toolStripMenuItem11_Click(object sender, EventArgs e)
        {
            AddnewLocalDrivingLicense frm = new AddnewLocalDrivingLicense();
            frm.ShowDialog();
        }
