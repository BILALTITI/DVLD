...
namespace DVLD
{
    public partial class TakeTest : Form
    {
        ...
        public TakeTest( int TestTypeID, int TestAppointmentsID)
        {
            _TestAppointmentsID = TestAppointmentsID;
            _TestTypeID = TestTypeID;

            _testAppointments =TestAppointment. TestAppointments.Find(TestAppointmentsID);
            InitializeComponent();
        }
