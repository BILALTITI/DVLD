...
namespace DVLD
{
    public partial class ShowManageinternationlLicence : Form
    {
        ...
        InternationalLicenses _Licenses;
        ...
        private void showPersonDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            cardDetails cardDetails = new cardDetails(internationalLicenses.Driversinfo.PersonID);
            cardDetails.Show();
        }
        ...
        private void showPersonLicenceHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
         ...
         InternationalLicenses internationalLicenses =
            ...
            Licence_History licence_History = new Licence_History(internationalLicenses.Driversinfo.PersonID);
