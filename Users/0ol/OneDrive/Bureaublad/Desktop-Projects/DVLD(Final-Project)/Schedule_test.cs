...
using static DVLD__Business_Layer.TestAppointment.TestAppointments;
...
namespace DVLD
{
    public partial class Schedule_test : Form
    {
        ...
        private int _LocalDrivingLicenseApplicationID = -1;
         TestAppointment.TestAppointments  _TestAppointment;
        private int _TestAppointmentID = -1;
        private   int   _TestTybeID=-1;
        


        public Schedule_test(int LocalDrivingLicenseApplicationsID,int TestApointmentID=-1,int TestTybe =1)
        {
        ...
        {
            _TestAppointment = TestAppointment.TestAppointments.Find(_TestAppointmentID);
           ...
           if (DateTime.Compare(DateTime.Now,_TestAppointment.AppointmentDate)>0)
            ...
            if (_TestAppointment.RetakeTest==-1)
            {
            ...
            else
            {
               lbRetakeFees2.Text=_TestAppointment.RetakeTestApplicationInfo.PaidFees.ToString() ;
                ...
                lbRetakeTestAPPID2.Text=_TestAppointment.RetakeTest.ToString   ();
        ...
        private void Schedule_test_Load(object sender, EventArgs e)
        {
            ...
            if (_Mode==enMode.AddNew)
            {
                ...
                _TestAppointment = new TestAppointment.TestAppointments();
            }
            else
            {
                 loadData(); 
        ...
        private bool HandelRetakeTest()
        {
            ...
            App.ApplicationDate=DateTime.Now;
                ...
                App.CreatedByUserID = 15;
           if (!App.Save())
                {
                    _TestAppointment.RetakeTest = -1;
                     MessageBox.Show("Failed To Create Application ","Failed",MessageBoxButtons.OK, MessageBoxIcon.Error);  
                    return false;
                }
                _TestAppointment.RetakeTest = App.ApplicationID;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.TestTypeID = _TestTybeID;
            ...
            _TestAppointment.CreatedByUserID = 15;
