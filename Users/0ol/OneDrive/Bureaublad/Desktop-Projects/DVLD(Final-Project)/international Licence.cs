...
namespace DVLD
{
    ...
    "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            _InterNationalLicense = new InternationalLicenses();
            lbApplicationID2.Text = _InterNationalLicense.ApplicationID .ToString();
    ...
    //lbLicenceId2.Text = internationalLicenses..ToString();
